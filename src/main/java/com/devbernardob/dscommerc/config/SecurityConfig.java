package com.devbernardob.dscommerc.config;
...
public class SecurityConfig {
    ...
    public void configureGlobal(AuthenticationManagerBuilder auth) throws Exception {
        ...
        auth.inMemoryAuthentication()
                .withUser("Bernardo").password(passwordEncoder.encode("12345")).roles("ADMIN")
                .and()
                .withUser("Eduardo").password(passwordEncoder.encode("98765")).roles("PACIENTE")
                .and()
                .withUser("Kaio").password(passwordEncoder.encode("121212")).roles("SECRETARIA");
